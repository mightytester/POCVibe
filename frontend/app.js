class ClipperApp {
    constructor() {
        ...
        // video-card-factory.js handles creating video card DOM elements
        this.videoCardFactory = new window.VideoCardFactory(this);
    ...
    async loadRoots() { return this.libraryManager.loadRoots(); }

    setupRootSelector() { this.libraryManager.setupRootSelector(); }

    async switchRoot(rootName) { return this.libraryManager.switchRoot(rootName); }
    ...
    createVideoCard(video) { return this.videoCardFactory.createVideoCard(video); }
